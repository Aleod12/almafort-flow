...
const ITEMS = [
  ...
  },
  {
    ...
    a: "Мы работаем преимущественно с юридическими лицами и ИП. Оплата по безналичному расчету (по выставленному счету), закрывающие документы передаем оперативно через системы ЭДО (Диадок, СБИС) или вместе с грузом.",
  },
];
