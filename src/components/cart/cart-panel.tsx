...
export function CartPanel() {
  ...
  return (
    <div className="space-y-8">
      ...
      {lines.length > 0 && (
        <div className="above-tabbar safe-bottom fixed inset-x-0 z-40 border-t border-border bg-card/97 px-4 py-3 shadow-[0_-8px_24px_oklch(0_0_0/0.1)] backdrop-blur md:hidden">
